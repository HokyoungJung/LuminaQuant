...
SCRIPT = Path(__file__).parents[1] / "scripts/research/run_event_driven_candidate_evaluation.py"
SPEC = importlib.util.spec_from_file_location("run_event_driven_candidate_evaluation", SCRIPT)
