...
def test_zero_alloc_entry_skipped_not_default_sized() -> None:
    ...
    strat = CrossSectionalNearLowRecoveryStrategy(_Bars(symbols), _Queue(), **_CAND_KWARGS)
    ...
    sized = CrossSectionalNearLowRecoveryStrategy(_Bars(symbols), _Queue(), **_CAND_KWARGS)
    sized._emit_targets(
