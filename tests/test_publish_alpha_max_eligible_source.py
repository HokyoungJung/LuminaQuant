...
def test_conflict_authorization_rejects_wrong_effects_and_key(tmp_path: Path):
    ...
    message = {
        ...
        "acquisition_run_id": "7359f1a8bc9f658d6778e152de1664199f517d069c30f4fae9866b76ddca3de4",
...
def test_signed_month_authorization_reconciles_only_exact_effects(tmp_path: Path):
    ...
    expected_run_id = "7359f1a8bc9f658d6778e152de1664199f517d069c30f4fae9866b76ddca3de4"
...
def test_main_authorized_reconciliation_is_atomic_and_idempotent(
    ...
    approval_path = tmp_path / "current-state-approval-v14.json"
