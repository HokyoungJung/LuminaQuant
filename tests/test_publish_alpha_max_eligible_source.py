...
def test_conflict_authorization_rejects_wrong_effects_and_key(tmp_path: Path):
    ...
    message = {
        ...
        "acquisition_run_id": "41ed4e09bd7b4af1793d3138e5d55d22d217d5fd4bd9477493d885e42fae1602",
...
def test_signed_month_authorization_reconciles_only_exact_effects(tmp_path: Path):
    ...
    expected_run_id = "41ed4e09bd7b4af1793d3138e5d55d22d217d5fd4bd9477493d885e42fae1602"
...
def test_main_authorized_reconciliation_is_atomic_and_idempotent(
    ...
    approval_path = tmp_path / "current-state-approval-v8.json"
