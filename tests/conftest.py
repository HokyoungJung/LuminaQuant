...
_PUBLIC_ONLY_TESTS = [
    ...
    "test_benchmark_formulaic_pipeline_script.py",
    "test_candidate_strategy_factory.py",
    "test_compute_ops.py",
    ...
    "test_futures_strategy_factory_script.py",
    ...
    "test_scan_alpha101_params_script.py",
    "test_strategy_catalog_new_strategies.py",
    "test_strategy_factory_library.py",
