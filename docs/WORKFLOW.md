...
- GitHub Actions is disabled for the private repository to avoid hosted-runner billing. Run the required lint, test, architecture, and packaging gates locally before each push.
