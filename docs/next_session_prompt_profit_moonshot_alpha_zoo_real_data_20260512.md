...
8. 결과/handoff를 `.omx/notepad.md`, `.omx/plans/...`, `docs/research_note/research_note.md`, `docs/session_handoff_*alpha_zoo*`, `var/reports/.../alpha_v2/crypto_fx_alpha_zoo_*`에 저장해. 연구노트는 반드시 업데이트하고, global research inventory/source ledger가 바뀌면 `docs/research_note/research_history.md` 및 `var/reports/.../research_history/` 갱신 여부도 명시해.
