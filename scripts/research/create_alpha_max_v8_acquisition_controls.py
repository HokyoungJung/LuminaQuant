...
CURRENT_APPROVAL_LEAF = "current-state-approval-v14.json"
...
PHASE_PREPARATION_REQUEST_ID = "d55e5232b72540e0e3480841ad982c1e8fc2a07fe461c612bd10b1a9a19b1955"
ONE_TOUCH_REQUEST_ID = "baf8c6a6204991629fd101985c8bc98bdc08ae97dde0d25fd06550db7d3fdeca"
...
ROLE_PINS = {
    ...
    "acquirer": (
        ...
        "ca4ac7a60de70bd87924971d7f5b179c516250a22566a0d5964326ebe4496ae3",
    ),
    "phase_wrapper": (
        CURRENT,
        "scripts/research/run_alpha_max_phase_preparation_from_eligible_source.py",
        "73f3fc0f0d876bcb7759dd8ebbe42c03ed2c6b6a1dbb2b52023cf34db24753fc",
    ),
}
