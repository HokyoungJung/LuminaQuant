...
- generated: `2026-06-05T11:31:32.458092Z`
...
| 3 | `dynamic_conviction_switch:t0.85_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 8.61% | 5/10 | -2.65% | 0.00% | 0.76 | 2.38 | 10.08% |
| 4 | `dynamic_conviction_switch:t0.90_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 8.61% | 5/10 | -2.65% | 0.00% | 0.76 | 2.38 | 10.08% |
| 5 | `dynamic_conviction_switch:t0.95_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 8.61% | 5/10 | -2.65% | 0.00% | 0.76 | 2.38 | 10.08% |
| 6 | `dynamic_conviction_switch:t1.00_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 8.61% | 5/10 | -2.65% | 0.00% | 0.76 | 2.38 | 10.08% |
| 7 | `profile_optuna:selected_train_validation_legal` | `profile_optuna` | `True` | `` | `False` | -2.47% | 5/10 | -16.68% | -0.73% | 0.08 | 0.13 | 31.33% |
| 8 | `cross_candidate_hybrid:hybrid_v3_6_train_validation_fit` | `cross_candidate_hybrid` | `True` | `` | `False` | -8.44% | 5/10 | -10.70% | -0.77% | -0.52 | -0.70 | 14.14% |
...
| 11 | `dynamic_conviction_switch:t0.85_strict_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 10.47% | 4/10 | -8.56% | -0.17% | 0.67 | 1.13 | 10.62% |
| 12 | `dynamic_conviction_switch:t0.90_strict_fallback` | `dynamic_conviction_switch` | `True` | `` | `False` | 10.47% | 4/10 | -8.56% | -0.17% | 0.67 | 1.13 | 10.62% |
...
| Rank | Candidate | Family | Clean | Reasons | Hard-stop | OOS comp | OOS pos | Min OOS | Latest OOS | Sharpe | Sortino | Max OOS MDD |
| ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `validation_selector:validation_calmar_mdd12` | `validation_selector` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -17.30% | 3/10 | -9.83% | -0.96% | -0.83 | -1.83 | 17.68% |
| 2 | `validation_selector:validation_sharpe_mdd10` | `validation_selector` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -21.85% | 3/10 | -10.62% | -0.17% | -1.08 | -1.96 | 17.68% |
...
| 4 | `validation_selector:validation_utility_mdd15` | `validation_selector` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -27.32% | 3/10 | -15.35% | -0.96% | -1.02 | -1.89 | 26.62% |
