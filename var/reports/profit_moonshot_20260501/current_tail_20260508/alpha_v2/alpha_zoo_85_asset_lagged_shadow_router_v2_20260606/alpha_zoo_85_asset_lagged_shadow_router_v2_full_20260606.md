...
- generated: `2026-06-06T07:49:25.921924Z`
...
| ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `lagged_shadow_leaf_router:core_warmup4_avg2_val05_mdd12` | `lagged_shadow_leaf_router` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 67.16% | 4/10 | -2.51% | 0.00% | 1.81 | 0.00 | 23.83 | 27.69% |
| 2 | `dynamic_conviction_switch:t0.85_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd30_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 34.39% | 3/10 | 0.00% | 0.00% | 1.12 | ∞ | ∞ | 27.69% |
| 3 | `dynamic_conviction_switch:t0.90_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd30_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 34.39% | 3/10 | 0.00% | 0.00% | 1.12 | ∞ | ∞ | 27.69% |
| 4 | `dynamic_conviction_switch:t0.95_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd30_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 34.39% | 3/10 | 0.00% | 0.00% | 1.12 | ∞ | ∞ | 27.69% |
| 5 | `dynamic_conviction_switch:t1.00_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd30_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 34.39% | 3/10 | 0.00% | 0.00% | 1.12 | ∞ | ∞ | 27.69% |
| 6 | `regime_opportunity_leaf_switch:strict30_relaxed15_cap150` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 33.94% | 4/10 | -17.00% | -0.18% | 0.90 | 1.52 | 2.25 | 29.13% |
| 7 | `regime_opportunity_leaf_switch:strict30_relaxed15_cap125` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 33.29% | 4/10 | -15.29% | -0.18% | 0.90 | 1.57 | 2.28 | 27.69% |
| 8 | `regime_opportunity_leaf_switch:strict30_relaxed20_cap150` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 31.53% | 4/10 | -18.87% | -0.18% | 0.82 | 1.30 | 2.06 | 29.13% |
| 9 | `dynamic_conviction_switch:t0.85_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 10 | `dynamic_conviction_switch:t0.90_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 11 | `dynamic_conviction_switch:t0.95_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 12 | `dynamic_conviction_switch:t1.00_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
...
| ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `lagged_shadow_leaf_router:core_warmup4_avg2_val05_mdd12` | `lagged_shadow_leaf_router` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 67.16% | 4/10 | -2.51% | 0.00% | 1.81 | 0.00 | 23.83 | 27.69% |
| 2 | `regime_opportunity_leaf_switch:strict30_relaxed15_cap150` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 33.94% | 4/10 | -17.00% | -0.18% | 0.90 | 1.52 | 2.25 | 29.13% |
| 3 | `regime_opportunity_leaf_switch:strict30_relaxed15_cap125` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 33.29% | 4/10 | -15.29% | -0.18% | 0.90 | 1.57 | 2.28 | 27.69% |
| 4 | `regime_opportunity_leaf_switch:strict30_relaxed20_cap150` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 31.53% | 4/10 | -18.87% | -0.18% | 0.82 | 1.30 | 2.06 | 29.13% |
| 5 | `mdd30_risk_scaled:profile_aggressive_val_mdd30_cap1_50` | `mdd30_risk_scaled` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 15.69% | 1/2 | -0.65% | 16.44% | 2.26 | 0.00 | 25.33 | 17.32% |
| 6 | `mdd30_risk_scaled:profile_aggressive_x1_50` | `mdd30_risk_scaled` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 15.69% | 1/2 | -0.65% | 16.44% | 2.26 | 0.00 | 25.33 | 17.32% |
| 7 | `regime_opportunity_leaf_switch:unscaled` | `regime_opportunity_leaf_switch` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 14.35% | 4/10 | -12.78% | -0.15% | 0.63 | 0.85 | 1.70 | 20.26% |
| 8 | `mdd30_barbell_blend:profile_aggressive_70_strict_balanced_30_x1_50` | `mdd30_barbell_blend` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | 12.76% | 1/2 | -4.17% | 17.67% | 1.51 | 0.00 | 4.24 | 15.29% |
| 9 | `mdd30_barbell_blend:strict_aggressive_70_strict_balanced_30_x1_25` | `mdd30_barbell_blend` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -2.81% | 0/1 | -2.81% | -2.81% | 0.00 | 0.00 | 0.00 | 8.48% |
| 10 | `mdd30_barbell_blend:profile_growth_60_strict_growth_40_x1_25` | `mdd30_barbell_blend` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -10.84% | 0/2 | -10.43% | -0.46% | -2.67 | -2.67 | 0.00 | 12.65% |
| 11 | `validation_selector:validation_calmar_mdd12` | `validation_selector` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -17.96% | 3/10 | -15.06% | -1.22% | -0.61 | -1.10 | 0.64 | 20.26% |
| 12 | `mdd30_barbell_blend:relaxed_aggressive_70_strict_growth_30_x1_50` | `mdd30_barbell_blend` | `False` | `post_oos_research_variant,requires_fresh_forward_shadow` | `False` | -19.46% | 1/5 | -16.00% | -0.84% | -0.89 | -1.70 | 0.51 | 21.09% |
