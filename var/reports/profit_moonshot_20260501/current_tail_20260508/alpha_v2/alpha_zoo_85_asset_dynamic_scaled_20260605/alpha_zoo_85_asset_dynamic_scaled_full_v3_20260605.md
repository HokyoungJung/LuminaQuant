...
- generated: `2026-06-05T15:49:22.809983Z`
...
- source JSON: `/home/hoky/Quants-agent/LuminaQuant/var/reports/profit_moonshot_20260501/current_tail_20260508/alpha_v2/alpha_zoo_85_asset_dynamic_scaled_20260605/alpha_zoo_85_asset_dynamic_scaled_full_v3_20260605.json`
- source sha256: `21ad6194c059c3c1233bb9eeced24c9c33aa8d198f8d39f02a16091a0ea953f7`
...
| ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `dynamic_conviction_switch:t0.85_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 2 | `dynamic_conviction_switch:t0.90_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 3 | `dynamic_conviction_switch:t0.95_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 4 | `dynamic_conviction_switch:t1.00_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 29.65% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 23.59% |
| 5 | `dynamic_conviction_switch:t0.85_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd15_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 24.45% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 19.29% |
| 6 | `dynamic_conviction_switch:t0.90_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd15_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 24.45% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 19.29% |
| 7 | `dynamic_conviction_switch:t0.95_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd15_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 24.45% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 19.29% |
| 8 | `dynamic_conviction_switch:t1.00_risk_capped_fallback_val_ret02_calmar80_gate_val_mdd15_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 24.45% | 3/10 | 0.00% | 0.00% | 1.13 | ∞ | ∞ | 19.29% |
| 9 | `dynamic_conviction_switch:t0.85_risk_capped_fallback_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 23.41% | 5/10 | -3.18% | 0.00% | 0.91 | 5.24 | 5.12 | 23.59% |
| 10 | `dynamic_conviction_switch:t0.90_risk_capped_fallback_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 23.41% | 5/10 | -3.18% | 0.00% | 0.91 | 5.24 | 5.12 | 23.59% |
| 11 | `dynamic_conviction_switch:t0.95_risk_capped_fallback_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 23.41% | 5/10 | -3.18% | 0.00% | 0.91 | 5.24 | 5.12 | 23.59% |
| 12 | `dynamic_conviction_switch:t1.00_risk_capped_fallback_val_mdd20_scaled` | `dynamic_conviction_switch` | `True` | `` | `False` | 23.41% | 5/10 | -3.18% | 0.00% | 0.91 | 5.24 | 5.12 | 23.59% |
...
- OOS comp: `29.65%`
- hit rate: `3/10`
- monthly Sharpe / Sortino approx: `1.13` / `∞`
- profit factor / omega(0): `∞` / `∞`
- 5% monthly VaR / 25% CVaR: `0.00%` / `0.00%`
- avg gain / avg loss: `9.81%` / `0.00%`
- gain/loss ratio: `∞`
- max loss streak: `0`
- mean/min validation: `8.61%` / `0.00%`
