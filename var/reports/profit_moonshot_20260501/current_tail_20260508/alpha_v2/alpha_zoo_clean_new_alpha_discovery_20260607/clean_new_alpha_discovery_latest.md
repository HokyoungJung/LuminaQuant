...
- OOS comp: `2.51%`
- annualized approx: `3.01%`
- monthly equity MDD: `10.28%`
- max OOS MDD: `8.77%`
- positive folds: `5/10`
- Sharpe approx: `0.24`
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `2025-09` | `az69_leadlag_1h_ethusdt_adausdt_lb12_thr0p01_lag0p25_hold8_lev4_335fc0f7` | `cross_asset_lead_lag_momentum` | 18.31% | 18.51% | -1.27% | 5.13% |
...
| `2025-11` | `az69_leadlag_4h_solusdt_avaxusdt_lb6_thr0p02_lag0p25_hold4_lev4_ab6deb9d` | `cross_asset_lead_lag_momentum` | 18.86% | 16.41% | -6.47% | 8.77% |
| `2025-12` | `az69_leadlag_4h_btcusdt_ethusdt_lb12_thr0p01_lag0p25_hold8_lev4_1d1fd779` | `cross_asset_lead_lag_momentum` | 38.13% | 14.79% | 4.39% | 2.39% |
