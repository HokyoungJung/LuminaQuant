...
- generated: `2026-06-02T11:47:32.392116Z`
...
| 4 | `mdd30_risk_scaled:dyn085_val_mdd30_cap1_50` | `mdd30_risk_scaled` | `False` | `False` | 84.64% | 5/10 | -3.97% | -1.07% | 2.07 | 15.16 | 27.17% |
| 5 | `mdd30_risk_scaled:dyn085_x1_50` | `mdd30_risk_scaled` | `False` | `False` | 84.64% | 5/10 | -3.97% | -1.07% | 2.07 | 15.16 | 27.17% |
| 6 | `mdd30_risk_scaled:dyn085_x1_25` | `mdd30_risk_scaled` | `False` | `False` | 68.68% | 5/10 | -3.31% | -0.89% | 2.07 | 15.24 | 23.07% |
| 7 | `mdd30_risk_scaled:dyn100_x1_50` | `mdd30_risk_scaled` | `False` | `False` | 61.04% | 5/10 | -3.97% | 0.00% | 1.69 | 10.72 | 27.17% |
| 8 | `dynamic_conviction_switch:t0.85_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `False` | 53.38% | 5/10 | -2.65% | -0.71% | 2.07 | 15.31 | 18.80% |
| 9 | `dynamic_conviction_switch:t0.90_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `False` | 53.38% | 5/10 | -2.65% | -0.71% | 2.07 | 15.31 | 18.80% |
| 10 | `dynamic_conviction_switch:t0.95_risk_capped_fallback` | `dynamic_conviction_switch` | `True` | `False` | 53.38% | 5/10 | -2.65% | -0.71% | 2.07 | 15.31 | 18.80% |
| 11 | `risk_enhanced_blend:dyn085_70_aware_v36tv_30` | `risk_enhanced_blend` | `False` | `False` | 47.60% | 5/10 | -2.35% | -0.73% | 1.98 | 16.23 | 14.67% |
| 12 | `risk_enhanced_blend:dyn085_60_aware_v36tv_40` | `risk_enhanced_blend` | `False` | `False` | 45.60% | 5/10 | -2.46% | -0.74% | 1.93 | 16.93 | 14.14% |
