...
- Coverage audit: official BTCUSDT daily archive listing currently ends at `2024-03-30`; `2025-12-01..2025-12-07` core5 probe returned all `35` symbol-days missing, so post-2024 BBO source coverage is the next blocker before any BBO-aware promotion rerun.
