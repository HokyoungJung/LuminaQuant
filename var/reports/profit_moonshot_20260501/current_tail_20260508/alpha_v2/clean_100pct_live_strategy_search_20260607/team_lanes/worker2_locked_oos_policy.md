...
## Exact-name companion artifact
- This file satisfies the Task 3 requested path `worker2_locked_oos_policy.md`; canonical detailed copy also exists at `worker_2_locked_oos_report_only_20260607.md`.
