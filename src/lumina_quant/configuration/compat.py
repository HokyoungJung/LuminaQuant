"""Compatibility config views for the backtest and live engines (Phase 1 bridge).
...
Phase 3/4 will migrate the engines to typed attrs directly.  Until then, construct
a view once per run and pass it through the call stack.
"""
