...
- Any promoted success has zero liquidations across train/validation/OOS, positive min buffers, OOS MDD <= 25%, and OOS return plus return/MDD above invalid reference economics.
